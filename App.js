...
import { CaptureAttendanceScreen } from './src/screens/captureAttendance';
    ...
    <Provider store={Store}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Home">
          ...
          <Stack.Screen name="CaptureAttendance" component={CaptureAttendanceScreen} options ={{headerShown : false}}/>
        </Stack.Navigator>
      </NavigationContainer>
    </Provider>
  );
